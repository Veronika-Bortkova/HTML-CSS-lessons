...
// console.log(user_1.greeting.call(user_3, "&&&", "15/07"));// call hаблотает также как єплай, но аргументі передаются не в массиве, а просто через запятую.- call удобно, когда аргументы уже известны и их немного.
